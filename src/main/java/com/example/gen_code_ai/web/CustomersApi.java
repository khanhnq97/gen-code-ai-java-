...
public interface CustomersApi {
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"password\" : \"password\", \"phone\" : \"phone\", \"customerId\" : 6, \"name\" : \"name\", \"avatar\" : \"avatar\", \"membershipStatus\" : \"Basic\", \"email\" : \"email\" }";
    ...
    default ResponseEntity<List<CustomerResponse>> getCustomers(
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "[ { \"password\" : \"password\", \"phone\" : \"phone\", \"customerId\" : 6, \"name\" : \"name\", \"avatar\" : \"avatar\", \"membershipStatus\" : \"Basic\", \"email\" : \"email\" }, { \"password\" : \"password\", \"phone\" : \"phone\", \"customerId\" : 6, \"name\" : \"name\", \"avatar\" : \"avatar\", \"membershipStatus\" : \"Basic\", \"email\" : \"email\" } ]";
                    ApiUtil.setExampleResponse(request, "application/json", exampleString);
                    break;
                }
            }
